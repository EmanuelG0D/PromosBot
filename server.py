...
RONDA_COMUNIDAD = ("slickdeals", "promocajita", "promohunter", "miloderrocha", "republica", "descuentostech")
        ...
        if ruta.path in ("/run_facebook", "/run_fb"):
            ...
            if "muestra" in qs:
                ...
                d1 = Deal(
                    ...
                    store="Falabella",
                    country="CO",
                    key=f"sample:falabella_{ts_now}",
                    title="Tenis Deportivos Hombre - Descuento Especial",
                    price=219900.0,
                    list_price=449900.0,
                    currency="COP",
                ...
                d2 = Deal(
                    ...
                    store="Amazon",
                    country="US",
                    key=f"sample:amazon_{ts_now}",
                    title="Zapatillas Deportivas Clásicas Unisex",
                    price=29.99,
                    list_price=75.0,
                    currency="USD",
