...
CATEGORIAS_BUSQUEDA: dict[str, list[str]] = {
    ...
    "airfryers": ["freidora de aire", "air fryer", "airfryer", "freidora"],
    "airfryer": ["freidora de aire", "air fryer", "airfryer", "freidora"],
    ...
    "🍿 Microondas": ["microondas", "horno electrico", "horno microondas"],
    "microondas": ["microondas", "horno electrico", "horno microondas"],
    ...
    "neveras": ["nevera", "refrigerador", "nevecon", "refrigeradora", "freezer"],
    "nevera": ["nevera", "refrigerador", "nevecon", "refrigeradora", "freezer"],
    "🧺 Lavadoras": ["lavadora", "secadora", "torre de lavado", "lavaseca"],
    "lavadoras": ["lavadora", "secadora", "torre de lavado", "lavaseca"],
    "lavadora": ["lavadora", "secadora", "torre de lavado", "lavaseca"],
    ...
    "audífonos y sonido": ["audifonos", "diadema", "parlante", "auriculares"],
    "audifonos y sonido": ["audifonos", "diadema", "parlante", "auriculares"],
    ...
    "tenis y zapatos": ["tenis", "zapatillas", "sneakers", "botas", "zapatos"],
    "👕 Camisetas y Polos": ["camiseta", "polo", "camisa", "t-shirt", "tshirt", "playera", "esqueleto"],
    "camisetas y polos": ["camiseta", "polo", "camisa", "t-shirt", "tshirt", "playera", "esqueleto"],
...
CATEGORIAS_BUSQUEDA_EN: dict[str, list[str]] = {
    ...
    "👕 Ropa y Moda": ["clothing", "hoodie", "jacket", "jeans", "nike", "adidas", "puma", "levis"],
    "🌟 Toda la Ropa": ["clothing", "hoodie", "jacket", "jeans", "shirt", "shoes", "sneakers", "nike", "adidas", "puma"],
    "👕 Camisetas y Polos": ["shirt", "t-shirt", "polo", "tee"],
    "👖 Jeans y Pantalones": ["jeans", "pants", "shorts", "jogger", "levis"],
    "🧥 Chaquetas y Buzos": ["jacket", "hoodie", "fleece", "coat", "sweatshirt"],
    "🩳 Ropa Deportiva": ["sportswear", "running", "athletic", "shorts", "activewear", "nike", "adidas", "under armour"],
}
